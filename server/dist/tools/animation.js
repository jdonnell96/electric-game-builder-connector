...
export const animationEdit = defineTool({
    ...
    async execute(args, { godot }) {
        switch (args.action) {
            ...
            case 'stop': {
                const result = await godot.sendCommand('stop_animation', {
                    node_path: args.node_path,
            ...
            case 'create_reset_keys': {
                const result = await godot.sendCommand('create_reset_keys', {
                    node_path: args.node_path,
                    animation_name: args.animation_name,
                });
                const lines = [
...
export const animationTools = [animationRead, animationEdit];
