...
const DoctorSchema = z.discriminatedUnion('action', [
    z.object({
        ...
        project_path: z
            .string()
            .optional()
            .describe('Godot project folder to inspect. Defaults to the project of the connected editor, then the ' +
...
export const doctor = defineTool({
    ...
    description: 'Diagnose the godot-mcp setup with no game open, and name the fix for each problem: who is listening ' +
...
export const doctorTools = [doctor];
