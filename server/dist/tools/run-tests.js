...
export const runTestsTool = defineTool({
    ...
    description: 'Prove the game works before showing it: run a headless test scene in a separate Godot process and get back ' +
...
export const runTestsTools = [runTestsTool];
