    ...
    describe('isWSL()', () => {
        ...
        describe('on Linux platform', () => {
            ...
            it('returns true when /proc/version contains "microsoft"', () => {
                vi.mocked(fs.readFileSync).mockReturnValue('Linux version 4.19.128-microsoft (oe-user@oe-host) (gcc version 9.3.0 (GCC))');
                expect(isWSL()).toBe(true);
            });
            ...
            it('returns false on native Linux with no WSL indicators', () => {
                vi.mocked(fs.readFileSync).mockReturnValue('Linux version 5.15.0-1234-generic (buildd@lcy02-amd64-001)');
            ...
            it('falls back to /proc/version when env vars not set', () => {
                vi.mocked(fs.readFileSync).mockReturnValue('Linux version 4.19.128-microsoft (oe-user@oe-host)');
                expect(isWSL()).toBe(true);
...
//# sourceMappingURL=wsl-detection.test.js.map