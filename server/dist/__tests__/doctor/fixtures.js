...
export const EDITOR_CMD = 'C:\\Users\\jackd\\Downloads\\Godot_v4.6.1\\Godot_v4.6.1-stable_win64.exe --path C:/Users/jackd/Documents/mc-daniels-burgers -e res://scenes/game.tscn';
export function conn(localPort, remotePort, state, pid) {
    return { localAddress: '127.0.0.1', localPort, remoteAddress: state === 'listen' ? '0.0.0.0' : '127.0.0.1', remotePort, state, pid };
}
export function proc(pid, ppid, name, commandLine) {
...
export function healthySnapshotWithGame() {
    ...
    return {
        ...
        processes: [
            ...
            proc(GAME_PID, EDITOR_PID, 'Godot_v4.6.1-stable_win64.exe', 'C:\\Users\\jackd\\Downloads\\Godot_v4.6.1\\Godot_v4.6.1-stable_win64.exe --path C:/Users/jackd/Documents/mc-daniels-burgers --remote-debug tcp://127.0.0.1:6007 --editor-pid 16448 res://scenes/game.tscn'),
        ],
    };
}
