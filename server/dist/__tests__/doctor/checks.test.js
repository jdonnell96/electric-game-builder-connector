...
import { checkBridgePort, checkDebugPort, checkEditors, checkExportTemplates, checkNodeVersion, checkProject, checkServerProcesses, exportTemplatesRoot, isGodotEditor, isGodotGame, isOtherGodotTool, isOurServer, projectPathFromCommandLine, serverPackageDir, templateVersionDir, } from '../../doctor/checks.js';
...
describe('checkProject', () => {
    ...
    let project;
    let bundled;
    function writeAddon(dir, version) {
...
describe('export templates', () => {
    ...
    it('lists the platforms present and missing', () => {
        ...
        for (const f of ['windows_release_x86_64.exe', 'web_release.zip', 'linux_release.x86_64', 'version.txt'])
