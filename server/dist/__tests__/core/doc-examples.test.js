...
import { sceneTools, nodeTools, editorTools, projectTools, animationTools, tilemapTools, resourceTools, scene3dTools, docsTools, inputTools, profilerTools, runtimeStateTools, gameTimeTools, execTools, validateMeshesTools, } from '../../tools/index.js';
const ALL_TOOLS = [
    ...sceneTools,
    ...nodeTools,
    ...editorTools,
...
describe('generated doc examples (#287)', () => {
    ...
    it('applies tool-scoped example overrides (docs path is a URL, node_edit properties is non-empty)', () => {
        ...
        const updateExample = buildVariantExample(updateCase.variant, updateCase.tool.schema, updateCase.tool.name);
