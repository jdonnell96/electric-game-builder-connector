...
const FALLBACK = 'project.godot was edited on disk after the editor loaded it; the editor may be showing ' +
...
export function staleAdvisory(staleness) {
    if (!staleness?.stale)
        return null;
    return `STALE PROJECT SETTINGS: ${staleness.summary ?? FALLBACK}`;
}
//# sourceMappingURL=project-staleness.js.map